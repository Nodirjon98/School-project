...
export const SEED_STUDENT_PERFORMANCE_RECORDS: StudentPerformanceRecord[] = [
  ...
  },
  {
    ...
    recentQuizzes: [
      { id: 'q-13', name: 'Speaking Practice Test', module: 'Speaking', score: 88, date: '2026-09-05', passed: true },
      { id: 'q-14', name: 'Academic Reading Passage', module: 'Reading', score: 86, date: '2026-09-03', passed: true }
    ],
